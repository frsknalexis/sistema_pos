                ...
                <div class="box">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-user"></i></span><input type="text" class="form-control" id="nuevoVendedor" value="<?php echo $_SESSION['nombre'];?>" readonly>
                      <input type="hidden" name="idVendedor" id="idVendedor" value="<?php echo $_SESSION['id_usuario']; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      $ventas = VentasController::mostrarVentasController($item, $valor);
